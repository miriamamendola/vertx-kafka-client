...
{@link io.vertx.kafka.client.consumer.KafkaConsumer#partitionsRevokedHandler(io.vertx.core.Handler)},
{@link io.vertx.kafka.client.consumer.KafkaConsumer#partitionsAssignedHandler(io.vertx.core.Handler)} and
{@link io.vertx.kafka.client.consumer.KafkaConsumer#partitionsLostHandler(io.vertx.core.Handler)}.
...
You can use {@link io.vertx.kafka.client.consumer.KafkaConsumer#assign(java.util.Set)}
...
Calling {@link io.vertx.kafka.client.consumer.KafkaConsumer#assignment()} provides
...
topic, avoiding to register the handler for getting the messages and then using the {@link io.vertx.kafka.client.consumer.KafkaConsumer#poll(Duration)} method.
...
Manual offset commit, can be achieved with {@link io.vertx.kafka.client.consumer.KafkaConsumer#commit()}.
